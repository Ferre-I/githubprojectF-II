...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glutWireSphere(0.25, 10, 10);  //Draw Mercury (radio,H,V);
	glPopMatrix();
	...
	glPushMatrix();
		...
		glutWireSphere(0.3, 10, 10);  //Draw Venus (radio,H,V);
	glPopMatrix();
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glutWireSphere(0.4, 10, 10);  //Draw Earth (radio,H,V);
		glPopMatrix();
		//Luna
		...
		glutWireSphere(0.2, 10, 10);  //Draw Moon (radio,H,V);
	glPopMatrix();
	...
	glPushMatrix();
		...
		glutWireSphere(0.35, 10, 10);  //Draw Mars (radio,H,V);
	glPopMatrix();
	...
	glPushMatrix();
		...
		glPushMatrix();
			glRotatef(planeta*3, 0.0, 1.0, 0.0);	//El Sol gira sobre su eje
			glutWireSphere(0.7, 10, 10);  //Draw Jupiter (radio,H,V);
		glPopMatrix();
		glPushMatrix();
			//Luna 1
			glColor3f(0.753, 0.753, 0.753);
	...
	glPushMatrix();
		...
		glPushMatrix();
			glRotatef(planeta * 3, 0.0, 1.0, 0.0);	//El Sol gira sobre su eje
			glutWireSphere(0.675, 10, 10);  //Draw Sun (radio,H,V);
		glPopMatrix();
	...
	glPushMatrix();
		...
		glutWireSphere(0.625, 10, 10);  //Draw Sun (radio,H,V);
	glPopMatrix();
